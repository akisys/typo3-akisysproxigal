# -*- coding: utf-8 -*-
#
# Akisys: Proximity Image Gallery documentation build configuration file, created by
# sphinx-quickstart on Thu Apr 18 02:31:10 2013.
#
...
project = u'Akisys: Proximity Image Gallery'
copyright = u'2013, Alexander Kuemmel'
...
htmlhelp_basename = 'AkisysProximityImageGallerydoc'
...
latex_documents = [
  ('Index', 'AkisysProximityImageGallery.tex', u'Akisys: Proximity Image Gallery Documentation',
   u'Alexander Kuemmel', 'manual'),
]
...
man_pages = [
    ('Index', 'akisysproximityimagegallery', u'Akisys: Proximity Image Gallery Documentation',
     [u'Alexander Kuemmel'], 1)
]
...
texinfo_documents = [
  ('Index', 'AkisysProximityImageGallery', u'Akisys: Proximity Image Gallery Documentation',
   u'Alexander Kuemmel', 'AkisysProximityImageGallery', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title     = u'Akisys: Proximity Image Gallery'
epub_author    = u'Alexander Kuemmel'
epub_publisher = u'Alexander Kuemmel'
epub_copyright = u'2012, Alexander Kuemmel'
